...
class AdminCategoryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AdminCategory/index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AppBundle\Form\AdminCategoryType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('AppBundle\Form\AdminCategoryType', $category);
